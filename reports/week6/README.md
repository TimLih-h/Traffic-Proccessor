...
| Team member | Issues | PRs / MRs | Review activity | Testing | Documentation | Transition / deployment |
|---|---|---|---|---|---|---|
| [mrZom49](https://github.com/mrZom49) | Opened and managed sprint/report work, including [#111](https://github.com/SWP-Team-46/Traffic-Proccessor/issues/111), [#115](https://github.com/SWP-Team-46/Traffic-Proccessor/issues/115), [#120](https://github.com/SWP-Team-46/Traffic-Proccessor/issues/120), and [#121](https://github.com/SWP-Team-46/Traffic-Proccessor/issues/121). | Authored/integrated [#112](https://github.com/SWP-Team-46/Traffic-Proccessor/pull/112), [#118](https://github.com/SWP-Team-46/Traffic-Proccessor/pull/118), [#123](https://github.com/SWP-Team-46/Traffic-Proccessor/pull/123), [#124](https://github.com/SWP-Team-46/Traffic-Proccessor/pull/124), and [#125](https://github.com/SWP-Team-46/Traffic-Proccessor/pull/125). Also merged team PRs into integration branches. | Approved [#122](https://github.com/SWP-Team-46/Traffic-Proccessor/pull/122); coordinated and merged several sprint PRs. | [#123](https://github.com/SWP-Team-46/Traffic-Proccessor/pull/123) records local testing and CI/CD testing for the integrated changes. | Added/updated README, roadmap, changelog, sprint-review material, architecture records, contribution guidance, and customer-handover material through [#112](https://github.com/SWP-Team-46/Traffic-Proccessor/pull/112) and [#124](https://github.com/SWP-Team-46/Traffic-Proccessor/pull/124). | Integrated `dev`, `Asignment-6`, and `main`; added customer handover material and coordinated the final sprint merge sequence. |
| [TimLih-h](https://github.com/TimLih-h) | Assigned to [#121 — Separate CNSS and TP](https://github.com/SWP-Team-46/Traffic-Proccessor/issues/121). | Authored and merged [#114 — Deployment simplification and bug fixes](https://github.com/SWP-Team-46/Traffic-Proccessor/pull/114); merged [#113](https://github.com/SWP-Team-46/Traffic-Proccessor/pull/113) into `dev`. | Approved the main integration PR [#123](https://github.com/SWP-Team-46/Traffic-Proccessor/pull/123). | Included a “Test build” commit in [#114](https://github.com/SWP-Team-46/Traffic-Proccessor/pull/114) and updated `test_TP+CN.py` for the final build. | Documented the simplified deployment commands and configuration in [#114](https://github.com/SWP-Team-46/Traffic-Proccessor/pull/114). | Separated TP from CNSS, simplified container startup, removed obsolete deployment pieces, and delivered deployment fixes in [#114](https://github.com/SWP-Team-46/Traffic-Proccessor/pull/114). |
| [jan-ajata](https://github.com/jan-ajata) | Work linked to [#10 — Graphical representation](https://github.com/SWP-Team-46/Traffic-Proccessor/issues/10). | Authored [#119 — Major frontend improvement and fixes](https://github.com/SWP-Team-46/Traffic-Proccessor/pull/119). | Approved the week-6 documentation PR [#112](https://github.com/SWP-Team-46/Traffic-Proccessor/pull/112). | No explicit completed test activity recorded in the sprint PRs. | Reviewed the documentation package in [#112](https://github.com/SWP-Team-46/Traffic-Proccessor/pull/112); no separate documentation PR authored during the period. | No explicit transition or deployment activity recorded during the period. |
| [inseeee](https://github.com/inseeee) | No issue explicitly linked to the sprint PR. | Authored [#113 — Dashboard theme switcher](https://github.com/SWP-Team-46/Traffic-Proccessor/pull/113). | No submitted review recorded during the period. | [#113](https://github.com/SWP-Team-46/Traffic-Proccessor/pull/113) documents local checks of every theme and persistence after page reload. | No separate documentation contribution recorded during the period. | No explicit transition or deployment activity recorded during the period. |
| [LimpingCoronation](https://github.com/LimpingCoronation) | Completed the work defined by [#115 — Reflection and retrospective](https://github.com/SWP-Team-46/Traffic-Proccessor/issues/115). | Authored [#122 — Week-6 reflection and retrospective](https://github.com/SWP-Team-46/Traffic-Proccessor/pull/122). | No submitted review recorded during the period. | Two automated checks passed on [#122](https://github.com/SWP-Team-46/Traffic-Proccessor/pull/122). | Added `reflection.md` and `retrospective.md` through [#122](https://github.com/SWP-Team-46/Traffic-Proccessor/pull/122). | No explicit deployment work recorded; retrospective material supports sprint handover and continuity. |
...
![Example reviewed issue-linked PR or MR](images/reviewed_issue-linked_PR.png)
